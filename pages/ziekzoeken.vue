...
const form = reactive<{ leverweek:number; rasId:number|null; weggegooid:number; reden:string; extraReden?:string }>({
  leverweek:0,
  rasId:null,
  weggegooid:0,
  reden:'te klein',
...
async function submit() {
  ...
  await $fetch('/api/ziekzoeken', { method:'POST', body: parsed.data })
  Object.assign(form, { leverweek:0, rasId:null, weggegooid:0, reden:'te klein', extraReden:'' })
  alert('Opgeslagen')
}
</script>
